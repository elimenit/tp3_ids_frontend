...
URL_API="http://host.docker.internal:15000/"
...
generar_punto_env() {
    echo "URL_API=http://host.docker.internal:15000/" > .env
    echo "FLASK_SECRET_KEY=una_clave_super_larga_y_super_hiper_mega_secreta" >> .env
    echo "FLASK_HOST=0.0.0.0" >> .env
    echo "FLASK_PORT=10000" >> .env
}
...
correr_container_docker() {
    ...
    docker run --name tp3_frontend --add-host=host.docker.internal:host-gateway --env-file .env -p 10000:10000 tp3_frontend 
